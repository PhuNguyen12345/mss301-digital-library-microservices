-- Seeds one PENDING fine for user a91940da-c7e0-477a-ba59-ca34756ced99, book_id 2.
-- Uses a sentinel loan_id (9000000002) unlikely to collide with real loans;
...
SELECT
    ...
    9000000002,
    2,
    'a91940da-c7e0-477a-ba59-ca34756ced99',
    'OVERDUE_RETURN',
    NOW() - INTERVAL '3 days',
    5000,
    0,
    ...
    NOW(),
    NOW()
WHERE NOT EXISTS (SELECT 1 FROM fines WHERE loan_id = 9000000002);
